...
const RegisterPage = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            const registeredEmail = registerData.find(i => values.email === i.email)
            if (!registeredEmail) {
    ...
    return (
        <>
            <div className={classes.container}>
                ...
                <p className={classes.alreadyReg}>Already registered <span className={classes.signIn} onClick={() => { navigate("/login") }}> Sign in?</span></p>
            </div>
